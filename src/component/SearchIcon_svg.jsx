...
const SearchIcon_svg = ({ fillColor_search, grandient1_search, grandient2_search}) => (
    <svg width="37" height="37" viewBox="0 0 37 37" fill="url(#gradient_search)" xmlns="http://www.w3.org/2000/svg">
        <g>
            <path d="M18.5 36.1367C28.2408 36.1367 36.1367 28.2408 36.1367 18.5C36.1367 8.76099 28.2408 0.863265 18.5 0.863265C8.75923 0.863265 0.863265 8.76099 0.863265 18.5C0.863265 28.2408 8.75923 36.1367 18.5 36.1367Z" stroke="url(#gradient)" strokeWidth="0.27347" strokeLinecap="round" strokeLinejoin="round"/>
        </g>
        ...
        <defs>
            <linearGradient id="gradient_search" x1="50%" y1="30%" x2="0%" y2="100%">
                <stop offset="0%" stopColor={grandient1_search} />
                <stop offset="50%" stopColor={grandient2_search} />
            </linearGradient>
        </defs>
    </svg>
